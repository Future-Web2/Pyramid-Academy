...
const FileCheck     = (p) => <Icon {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><polyline points="9 15 11 17 15 13"/></Icon>;
const Calculator    = (p) => <Icon {...p}><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="8" y1="10" x2="8" y2="10"/><line x1="12" y1="10" x2="12" y2="10"/><line x1="16" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="8" y2="14"/><line x1="12" y1="14" x2="12" y2="14"/><line x1="16" y1="14" x2="16" y2="14"/><line x1="8" y1="18" x2="16" y2="18"/></Icon>;
...
const Languages     = (p) => <Icon {...p}><path d="M5 8h14"/><path d="M5 8a3 3 0 0 1 6 0"/><path d="M3 12h6"/><path d="M21 18l-5-10-5 10"/><path d="M13 14h6"/></Icon>;
...
const Sparkles      = (p) => <Icon {...p}><path d="M12 3l1.9 5.8L20 11l-6.1 2.2L12 19l-1.9-5.8L4 11l6.1-2.2z"/></Icon>;
...
const Instagram     = (p) => <Icon {...p}><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></Icon>;

Object.assign(window, {
  Icon, GraduationCap, Globe, FileCheck, Calculator, Brain, Languages,
  BookOpen, ArrowRight, MapPin, Phone, Clock, Mail, Award, Sparkles,
  Users, ChevronDown, Instagram,
});
